        ...
        return (
            <View>
                ...
                <View style={styles.icon}>
                    <Icon.Button name="music" size={30} onPress={increment}>{JsConfig.API_HOST}</Icon.Button>
                </View>
                <View style={styles.icon}>
                ...
                <View style={styles.icon}>
                    <Icon.Button name="video-camera" size={30} onPress={ () => incrementAsync(2000)}>Increment async</Icon.Button>
                </View>
            </View>
        );
    }
